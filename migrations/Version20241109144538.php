 ...
 */
final class Version20241109144538 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id SERIAL NOT NULL, title VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, poster VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE review (id SERIAL NOT NULL, reviewer_id INT NOT NULL, movie_id INT NOT NULL, text TEXT NOT NULL, rating DOUBLE PRECISION NOT NULL, rating_data JSON NOT NULL, is_approved BOOLEAN NOT NULL, sentiment_rating DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id))');
